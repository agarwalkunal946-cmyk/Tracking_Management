...
const deliverySchema = new mongoose.Schema({
  ...
  receiptSerialNo: { type: String, required: true, trim: true, maxlength: 30 },
  itemSize: { type: Number, required: true, min: 1 },
  amount: { type: Number, required: true, min: 1 },
  balance: { type: Number, required: true, min: 0 },
  driverName: { type: String, required: true, trim: true, maxlength: 80 },
  staffName: { type: String, required: true, trim: true, maxlength: 80 },
